...
import { HMAC_WINDOW_SECS, HMAC_NONCE_SWEEP_MS } from "../config/timeouts";
import { MAX_NONCE_MAP_SIZE, MAX_NONCE_LENGTH } from "../config/limits";
import { LOOPBACK_IP, LOOPBACK_IPV6_MAPPED } from "../config/server";
...
// Background sweep: evict expired nonces (O(n) but infrequent)
setInterval(() => {
